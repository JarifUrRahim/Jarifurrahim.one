...
<head>
  ...
  <link rel="canonical" href="https://iqra.jarifurrahim.one/chapters/${outName}" />
...
<body>
  ...
  <main class="shell">${body}<a class="back" href="../">← Back to the book</a></main>
  <footer class="foot">© 2026 G. K. M. Jarif Ur Rahim · <a href="https://jarifurrahim.one">jarifurrahim.one</a></footer>
</body>
</html>`;
