...
<link rel="canonical" href="${chapterUrl}" /><link rel="author" href="${publication.author.url}" /><meta name="author" content="${escapeHtml(publication.author.name)}" />
...
<body><header class="top"><div><a href="../">iqra · Book Edition 2</a><span>Edition 2.0</span></div></header><main class="shell">${body}${renderDiscoveryPanel(slug)}<a class="back" href="../">← Back to Edition 2</a></main><footer class="foot">© 2026 G. K. M. Jarif Ur Rahim · <a href="${publication.author.url}" rel="author">Author record</a> · <a href="${publication.author.orcid}" target="_blank" rel="noopener noreferrer">ORCID</a></footer></body></html>`;
