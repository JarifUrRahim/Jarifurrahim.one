...
for (const file of sourceFiles) {
  ...
  const edition = publication.editions['2.0'];
  const chapterUrl = `${publication.siteUrl}/edition-2/chapters/${outName}`;
...
<link rel="canonical" href="${chapterUrl}" /><link rel="author" href="${publication.author.pageUrl}" /><meta name="author" content="${escapeHtml(publication.author.name)}" />
